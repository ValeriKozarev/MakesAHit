...
# read global values for your keys and IDs
CLIENT_API_KEY = ''
SECRET_API_KEY = ''
USER_ID = ''
PLAYLIST_ID = ''
...
def connect_to_API():
    client_credentials_manager = SpotifyClientCredentials(CLIENT_API_KEY, SECRET_API_KEY)
...
def main():
    ...
    while current_index < total_tracks:
        ...
        training_playlist_batch = sp.user_playlist_tracks(USER_ID, PLAYLIST_ID, offset=current_index)
